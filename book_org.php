...
$query="create table BooksOrganisations(Name varchar(30),Phone_No varchar(40),Address varchar(50),Weight int,BookType varchar(20));";
...
$query1="INSERT INTO BooksOrganisations VALUES(?,?,?,?,?);";
